...
public class Server {
    ...
    public Server(int serverPort) {
        ...
        this.serverCommunicator = new ServerCommunicator(serverPort);
...
//
//        int serverPort = 17; //TODO get server port
//
////        Hashtable facilTable = new Hashtable<>();
//        bookingManager = new BookingManager();
//        serverCommunicator = new ServerCommunicator(serverPort);
//
//    }

    private void run() {
        ClientRequest clientRequest = serverCommunicator.receive();
